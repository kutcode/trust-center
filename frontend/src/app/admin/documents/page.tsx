  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        />
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100">Document Management</h1>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
              ...
              <tbody className="bg-white dark:bg-slate-900 divide-y divide-gray-200 dark:divide-slate-700">
                {pagination.paginatedItems.map((doc) => (
                  <tr key={doc.id} className="hover:bg-gray-50 dark:hover:bg-slate-800/80">
                    <td className="px-6 py-4">
                      <div className="text-gray-900 dark:text-gray-100 max-w-md truncate font-medium" title={doc.title}>{doc.title}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="max-w-xs truncate text-sm text-gray-600 dark:text-gray-300">{doc.document_categories?.name || 'Uncategorized'}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <Link href={`/admin/documents/${doc.id}`} className="text-blue-600 hover:text-blue-800 dark:hover:text-blue-300 font-medium mr-4">
                        Edit
                      </Link>
                      <button
