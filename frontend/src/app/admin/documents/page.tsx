        ...
        <div className="overflow-x-auto">
          {documents.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mt-1">Get started by uploading your first document.</p>
            </div>
          ) : (
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {documents.map((doc) => (
                  <tr key={doc.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${doc.status === 'published' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                        }`}>
                        {doc.status}
                      </span>
                    </td>
